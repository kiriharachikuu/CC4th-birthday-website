...
var user_configuration={
	...
	colors:["hsla(40, 100%, 50%, 0.5)", "rgba(26, 175, 255, 0.5)","hsla(164, 100%, 33%, 0.5)","hsla(244, 6%, 76%, 1.0)","hsla(349, 90%, 36%, 0.5)","hsla(60, 100%, 50%, 0.5)"], //The variety of colors of the stars. Can be any CSS complient color (eg. HEX, rgba, hsl)
